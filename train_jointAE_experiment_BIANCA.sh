...
do
   for value in "${CpGtypes[@]}"
    do
        for drop in "${drops[@]}"
        do
            python3 TrainCV_JointAE.py  "innerDNNClassifier" "test_grid_jointAE_BIANCA" 2000 3 "$alpha" \
...
cp -r /proj/sens2023584/Depression_methylation_multicohort_meta/test_grid_jointAE_BIANCA /proj/sens2023584/nobackup/wharf/aleso209/aleso209-sens2023584/test_grid_jointAE_BIANCA